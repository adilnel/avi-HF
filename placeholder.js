...
let container;
           ...
           let objects =[{name:"Sphere.8",translation:{x:-351.04638671875,
                   y: 331,
                    z:-330}},
                    {name:"Sphere.7",
                    translation:{x:-133,
                   ...
                   z: -253}}
                    ...
                    {
                        name:"Sphere.2",
                translation:{x:-317.0972900390625,
               y: 141.1907958984375,
                z:-97.6946716308594}
                    }];
...
// console.log(gltf.scene)
   ...
   scene.background = new THREE.Color( 0xD60000 )
...
whitelight.convertSRGBToLinear();
			...
			// metalness:0,
                ...
                var ground = new Physijs.BoxMesh( new THREE.BoxGeometry( 800, 30,800 ), ground_material, 0 );
                ground.position.set( -61.3784065246582, 0, -290.60125732421877 );
                ...
                var groundback = new Physijs.BoxMesh( new THREE.BoxBufferGeometry( 1600, 1200,0 ), ground_material, 0 );
                groundback.position.set( 0, 200, -900 );
                groundback.receiveShadow = true;
                groundback.castShadow = false;
...
// mesh SLIDER TESTING
				...
				var mesh;
				var geometry = new THREE.BoxBufferGeometry( 150, 150,2 );
...
var mesh11 = new THREE.Mesh(new THREE.PlaneBufferGeometry(20, 20, 2), new THREE.MeshBasicMaterial({
	color: 0xaa00ff
}));
mesh11.position.x = 90;
mesh.add(mesh11);
var mesh12 = new THREE.Mesh(new THREE.BoxBufferGeometry(20, 20, 2), new THREE.MeshBasicMaterial({
	color: 0xaa00ff
}));
...
// objects
   ...
   light_2.position.set(100, 50, 10);
 //   light_2.target.position.set = (-61.3784065246582, 300, -290.60125732421877);
   light_2.target = ground;
...
light_2.shadow.camera.near = 1;
light_2.shadow.camera.far = 2500;
light_2.shadow.camera.left = 500;
light_2.shadow.camera.right = 500;
light_2.shadow.camera.top = 500;
light_2.shadow.camera.bottom = -500;
camera.updateProjectionMatrix();
const helper = new THREE.DirectionalLightHelper( light_2, 5 );
scene.add( light_2 );
// scene.add( light_2.target );

setTimeout(() => {
	scene.add(new THREE.CameraHelper(light_2.shadow.camera));
}, 10000);
console.log(light_2.shadow.camera)
console.log(light_2.shadow)
scene.add( helper );
...
function createDrop(object) {
    ...
    // var color = new THREE.Color( 0xD60000);
