...
let group,phone, objects, container ,camera, scene, renderer, composer, composer2, fxaaPass, controls
,windowHalfX = window.innerWidth / 2
,windowHalfY = window.innerHeight / 2
,mouseX = windowHalfX
,mouseY = windowHalfY;
objects =[{name:"Sphere.8",translation:{x:-4,
       y: 3.57,
        z:-3.88, r:0.15}},
        {name:"Sphere.7",
        translation:{x:-1.33,
...
var color = new THREE.Color( 0x991503);
var material =
...
sphere.position.set(parseInt(object.translation.x),parseInt(object.translation.y), parseInt(object.translation.z));
...
return sphere
    ...
    // ground
    const groundMaterial = Physijs.createMaterial(new THREE.MeshStandardMaterial( { color: 0xfe2a05 } ), 1, 1);
    const groundMaterial1 = new THREE.MeshStandardMaterial( { color: 0xea2503 } );
    groundMaterial1.opacity = 0;
    groundMaterial1.transparent = true;
    const ground = new THREE.Mesh( new THREE.PlaneBufferGeometry( 10, 10, 1, 0.08 ), groundMaterial );
    // ground.rotation.x = - Math.PI / 2;
    // ground.receiveShadow = true;
    // ground.castShadow = true;
    // ground.position.set(-0.61,0,-2.9);
    const column = new THREE.Mesh( new THREE.BoxBufferGeometry( 1, 2, 1 ), groundMaterial1 );
...
const GROUND =  new Physijs.BoxMesh( new THREE.BoxBufferGeometry( 14, 0.5, 14 ), groundMaterial );
GROUND.position.y = -1;
GROUND.position.z = -4;
GROUND.castShadow = true;
GROUND.receiveShadow = true;
